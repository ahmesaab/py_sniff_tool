...
while True:
    ...
    if eth_protocol == 8 :
        ...
        if protocol == 6 :
            ...
            #print 'NETWORK LAYER::::: Source Address : ' + str(s_addr) + ' Destination Address : ' + str(d_addr);
             
            #print 'TRANSPORT LAYER::: Source Port : ' + str(source_port) + \
            #    ' Dest Port : ' + str(dest_port) + ' Sequence Number : ' + str(sequence) + ' Acknowledgement : ' + \
		...
		for line in lines[1:]:
			try:
				...
				break;
                print str(s_addr)+' is requesting from'+host+" ("+str(d_addr)+")";
